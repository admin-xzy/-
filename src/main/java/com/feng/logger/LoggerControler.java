...
public class LoggerControler {
    ...
    private static com.feng.logger.LoggerControler loggCon=null;
    public static com.feng.logger.LoggerControler getLogger(Class<?> T) {
        if(logger==null){
            ...
            try {
                ...
                loggCon=new com.feng.logger.LoggerControler();
            } catch (IOException e) {
                e.printStackTrace();
            }
